  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/2 h-[650px] w-[650px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#C6A15B]/[0.035] blur-[170px]" />

        <div className="absolute left-0 top-0 h-px w-full bg-gradient-to-r from-transparent via-[#C6A15B]/20 to-transparent" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-[1180px] px-5 sm:px-8 lg:px-10">
        <div className="mx-auto mb-16 max-w-3xl text-center sm:mb-20">
          ...
          <h2 className="font-serif text-4xl leading-[1.05] tracking-[-0.03em] text-[#E8E0D0] sm:text-5xl md:text-6xl">
            What I Was Never
            <br />
        ...
        <div className="grid items-start gap-12 lg:grid-cols-[380px_1fr] lg:gap-20">
          <div className="lg:sticky lg:top-24">
            <div className="relative mx-auto max-w-[360px]">
              <div className="absolute left-1/2 top-1/2 h-[85%] w-[75%] -translate-x-1/2 -translate-y-1/2 bg-[#C6A15B]/10 blur-[90px]" />

              <div className="relative border-2 border-[#80652F] bg-[#080807] p-[4px] shadow-[0_30px_80px_rgba(0,0,0,0.8)]">
            ...
            <div className="border border-[#C6A15B]/10 bg-[#11100D]/60 p-7 sm:p-10 lg:p-12">
              ...
              <div className="mt-9 space-y-7 text-sm leading-7 text-[#8F8A7D] sm:text-base sm:leading-8">
                ...
                <div className="border-l border-[#C6A15B]/60 pl-6">
                  <p className="font-serif text-xl italic leading-relaxed text-[#D7CDBD] sm:text-2xl">
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-3 border-y border-[#C6A15B]/10 py-7 sm:grid-cols-3">
                  {[
                    "Their fears.",
                    "Their desires.",
                    "Their beliefs.",
                ...
                <div className="border border-[#C6A15B]/15 bg-black/20 px-6 py-7 text-center">
                  ...
                  <div className="mx-auto my-5 h-px w-8 bg-[#C6A15B]/40" />
                ...
                <div className="border-t border-[#C6A15B]/10 pt-9">
                  ...
                  <p className="mt-4 font-serif text-2xl text-[#E8E0D0] sm:text-3xl">
        ...
        <div className="mt-20 text-center">
          <div className="mx-auto h-px w-12 bg-[#C6A15B]/50" />
